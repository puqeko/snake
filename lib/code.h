...
// Uses messege queue so that we don't have conflicts when sending and
// receiving codes between Funkits.
//
...
// Check if there are messages to read with code_has_message(), then
