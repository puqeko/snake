...
#define CYCLE_PERIOD 200 // desired cycle period in milliseconds
#define CYCLE_COUNT ((CYCLE_PERIOD / 1000) * LOOP_RATE) // number of times pacer_wait() is called
#define FOOD_NUM_CYCLES 6 // Note: this is the on and off periods combined!
#define PUSH_NUM_CYCLES 2 //                ^ as above ^
