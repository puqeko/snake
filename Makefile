...
game.o: ./game.c ../../drivers/display.h ../../drivers/avr/system.h ../../utils/task.h ../../drivers/avr/timer.h ./game.h ../../drivers/led.h
	$(CC) -c $(CFLAGS) $< -o $@
...
game.out: game.o task.o timer.o system.o led.o pio.o display.o ledmat.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
